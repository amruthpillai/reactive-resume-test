...
Whether you want to use our hosted version or run your own instance, we've got you covered.
...
<CardGroup cols={3}>
  ...
  <Card title="Reddit" icon="reddit" href="https://www.reddit.com/r/reactiveresume/">
  ...
  <Card title="Sponsor" icon="heart" href="https://opencollective.com/reactive-resume">
    Support the development of Reactive Resume.
  </Card>
</CardGroup>
