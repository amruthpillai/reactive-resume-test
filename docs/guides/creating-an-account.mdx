...
<Steps>
  ...
  <Step title="Sign up and log in">
    ...
    <Tip>
      No email verification is required to get started. However, we highly recommend verifying your email address for account security.
    </Tip>
  </Step>
  
  <Step title="Verify your email (recommended)">
    While email verification is optional, we strongly recommend verifying your email address. This helps in:
