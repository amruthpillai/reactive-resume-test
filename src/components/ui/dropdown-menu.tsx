...
function DropdownMenuContent({ className, sideOffset = 4, portal = true, ...props }: DropdownMenuContentProps) {
	const content = (
	...
	if (portal) return <DropdownMenuPrimitive.Portal>{content}</DropdownMenuPrimitive.Portal>;
