...
export function BreakpointIndicator({ position = "bottom-right" }: BreakpointIndicatorProps) {
	...
	return (
		<div
			className={cn(
				"fixed z-50 flex size-10 items-center justify-center bg-blue-900 p-2 font-bold font-mono text-white text-xs opacity-80 transition-opacity hover:opacity-40",
				top,
				right,
				left,
				bottom,
